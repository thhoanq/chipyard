...
//	sha3_soft_reset();
	...
	kprintf("# SHA3-512 ===============================================================\r\n");
	kprintf("Message:  \"The quick brown fox jumps over the lazy dog \"\r\n");
	kprintf("Expected: 01dedd5de4ef14642445ba5f5b97c15e47b9ad931326e4b0727cd94cefc44fff23f07bf543139939b49128caf436dc1bdee54fcb24023a08d9403f9b4bf0d450\r\n");
	kprintf("Digest:   ");
	for(int i = 0; i < 16; i++)
		kprintf("%w", digest[i]);
  kprintf("\r\n\r\n");
...
//	sha3_soft_reset();
	...
	kprintf("# SHA3-512 ===============================================================\r\n");
	kprintf("Message:  \"The quick brown fox jumps over the lazy dog.\"\r\n");
	kprintf("Expected: 18f4f4bd419603f95538837003d9d254c26c23765565162247483f65c50303597bc9ce4d289f21d1c2f1f458828e33dc442100331b35e7eb031b5d38ba6460f8\r\n");
	kprintf("Digest:   ");
	for(int i = 0; i < 16; i++)
		kprintf("%w", digest[i]);
